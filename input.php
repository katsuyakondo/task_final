     ...
     <form action="voice_create.php" method="post" enctype="multipart/form-data">
        ...
        <table border="0" width="100%" cellspacing="3" cellpadding="0">
            <tr class="options" style="display:none;">
                <td width="270">&nbsp;ワンタイムAppKey発行API URL</td>
                <td><input type="text" class="text" id="issuerURL" spellcheck="false" tabindex="1"></td>
            </tr>
            <tr class="options" style="display:none;">
                <td>&nbsp;サービス ID</td>
                <td><input type="text" class="text" id="sid" spellcheck="false" tabindex="1"></td>
            </tr>
            <tr class="options" style="display:none;">
                <td>&nbsp;サービスパスワード</td>
                <td><input type="password" class="text" id="spw" spellcheck="false" autocomplete="on" tabindex="1"></td>
            </tr>
        ...
        <table border="0" width="100%" cellspacing="3" cellpadding="0">
            ...
            <tr class="options" style="display:none;">
                <td>&nbsp;プロファイル ID</td>
                <td><input type="text" class="text" id="profileId" spellcheck="false" tabindex="3"></td>
            </tr>
            <tr class="options" style="display:none;">
                <td>&nbsp;プロファイル単語</td>
        ...
        <div style="margin: 20px 2px 24px 2px;">
            <b>[録音の開始]</b> ボタンを押して、マイクに向かって話してください。 <img
                src="data:image/gif;base64,R0lGODlhCgAPAMIAAAAAABYWFqqqqufn5////wAAAAAAAAAAACH5BAEKAAcALAAAAAAKAA8AAAMmSLq8E2E0AiqY9raMba/MxWmiRw4ZqgACdQka3BLyAltzqDF3NScAOw=="
                alt="" width="10" height="15"> マイクの使用や共有などを求められた場合は、「許可」 ボタンまたは 「共有」 ボタンを押してください<span
                class="toggle_options">。</span>
        </div>
        
        <!-- 隠しフィールド -->
        <!-- <input type="hidden" name="audioData" id="audioData"> -->
            <input type="hidden" name="recognizedText" id="recognizedText">
